  ...
  <div class="nav_wrap">
    ...
    <nav class="nav js-nav">
      <ul class="depth1_list">
        <li class="depth1_menu js-depth1_menu">
          <a href="#" class="depth1_title js-depth1_title">
            자료검색
            <span class="arrow_box js-arrow_box"><img src="images/arrow_down_gray.png" alt="화살표"></span>
          </a>
